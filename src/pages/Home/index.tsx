...
import { getTotalVolume, getAvgPrice } from "../../services/admin";
            ...
            <Row style={{ marginTop: "3%" }}>
              <Col>
                ...
                >
                  <p style={{ fontSize: "0.6rem" }}>
                    ...
                    {/* <span style={{ marginLeft: "10%", color: "#DE5753" }}>
                      <span style={{ marginRight: "2%" }}>🡣</span>400%
                    </span> */}
                  </p>
              ...
              <Col>
                ...
                >
                  ...
                  >
                    {avgprice
                      ? `$${avgprice.avgprice.toFixed(2)}/BCLT`
                      : "Loading..."}
                  </p>
                </div>
              </Col>
